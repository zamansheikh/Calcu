...
class AppTheme {
  static ThemeData defalultTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      onSurface: Color.fromARGB(255, 217, 220, 226), //Number button color
      tertiary: Color.fromARGB(255, 159, 167, 180), //Sp button color
      onTertiary: Color(0xFF0060E5), //Op button color
    ),
  );
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      ...
      onSurface: Color(0xFF242933), //Number button color
      tertiary: Color(0xFF363E4C), //Sp button color
      onTertiary: Color(0xFF0060E5), //Op button color
    ),
  );
}
